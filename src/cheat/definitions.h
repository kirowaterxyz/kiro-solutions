...
enum class BoneID : int {
	HeadBone = 68, // 5 31 2025
	BottomBone = 0, // ???
	NeckBone = 66, // 5 31 2025
	HipBone = 2, // 5 31 2025 Pelvis
	UpperArmLeftBone = 9, // 5 31 2025
	UpperArmRightBone = 38, // 5 31 2025
	LeftHandBone = 10, // 5 31 2025
	RightHandBone = 39,	// 5 31 2025
	LeftHandTBone = 11, // 5 31 2025
	RightHandTBone = 40, // 5 31 2025
	RightThighBone = 78, // 5 31 2025
	LeftThighBone = 71, // 5 31 2025
	RightCalfBone = 79, // 5 31 2025
	LeftCalfBone = 72, // 5 31 2025
	LeftFootBone = 75, // 5 31 2025
	RightFootBone = 82 // 5 31 2025
};
...
struct PlayerCache {
	...
	chrono::system_clock::time_point lastWeaponUpdate = std::chrono::system_clock::now();
	float last_render = 0;
	int KillScore = 0;
	int SeasonLevelUIDisplay = 0;
